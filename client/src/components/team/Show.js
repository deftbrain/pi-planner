  ...
  render() {
    ...
    return (
      <div>
        ...
        {item && (
          <Link to={`/teams/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = state => ({
  ...
  error: state.team.show.error,
  loading: state.team.show.loading,
  eventSource: state.team.show.eventSource,
  deleteError: state.team.del.error,
  deleteLoading: state.team.del.loading,
