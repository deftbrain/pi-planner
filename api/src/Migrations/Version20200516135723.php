 ...
 */
final class Version20200516135723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sprint (id INT NOT NULL, schedule_id INT NOT NULL, external_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, sprint_schedule_id INT NOT NULL, external_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEF0A3F61D ON project (sprint_schedule_id)');
        $this->addSql('CREATE TABLE workitem (id INT NOT NULL, project_id INT NOT NULL, team_id INT DEFAULT NULL, sprint_id INT DEFAULT NULL, epic_id INT NOT NULL, backlog_group_id INT NOT NULL, external_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, estimate_frontend DOUBLE PRECISION DEFAULT NULL, estimate_backend DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE backlog_group (id INT NOT NULL, project_id INT NOT NULL, external_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
